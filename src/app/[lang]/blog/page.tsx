...
export default async function  Blog({ params }: any) {
    ...
    <html lang={params.lang}>
        <head>
            ...
            <meta name="description" content="Dapatkan kabar terbaru mengenai perkembangan cryptocurrency di Triv Blog. Informasi berita kripto (Crypto News) hari ini paling update." />
            ...
            <meta property="og:description" content="Dapatkan kabar terbaru mengenai perkembangan cryptocurrency di Triv Blog. Informasi berita kripto (Crypto News) hari ini paling update." />
            <meta property="og:url" content="https://blog.triv.co.id/" />
            <meta property="og:site_name" content="Triv Blog" />
            <meta property="og:image" content="https://blog.triv.co.id/wp-content/uploads/2023/08/logo-full.png" />
