...
export default async function LoginPage({ params }: any) {
  const dictLogin = await getDictionaryLogin(params.lang);
  ...
  return (
    <html lang={params.lang}>
      ...
      <body>
        <main className="login-page sm:mobile-responsive lg:medium-responsive">
          <Login lang={params.lang} dictLogin={dictLogin} />
        </main>
      </body>
    </html>
  );
