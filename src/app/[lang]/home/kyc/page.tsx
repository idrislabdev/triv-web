...
import KYCContentSection from '@/@core/pages/kyc/content-section';
import KYCHeaderSection from '@/@core/pages/kyc/header-section';
import PrivacyContentSection from '@/@core/pages/privacy-policy/content-section';
import PrivacyHeaderSection from '@/@core/pages/privacy-policy/header-section';
import '@/styles/privacy-kyc.css';

export default async function KYC({ params }: any) {
  return (
      ...
      <head>
        {params.lang === 'id' && (
          <>
            ...
            <meta content="KYC" name="twitter:title" />
            <meta
              content="translation missing: id.layouts.front.meta.contact.description"
