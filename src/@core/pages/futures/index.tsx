...
const FuturesPage = (props: {
  ...
  return (
    <>
      ...
      <main className="futures-page sm:mobile-responsive md:mobile-responsive">
        ...
        <FuturesWhyCryptoSection
          objLang={objLang.what_why_section}
          lang={lang}
        />
        <FuturesListCoinSection
          objLang={objLang.list_coints_section}
          lang={lang}
          prepsInstrument={prepsInstrument}
        />
        <FuturesStepSection objLang={objLang.step_section} />
        <FuturesPemisahanSection
          objLang={objLang.pemisahan_section}
          lang={lang}
        />
