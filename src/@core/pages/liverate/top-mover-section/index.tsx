    ...
    return (
        <div className='liverate-top-mover-section'>
            ...
            <div className='top-mover-containers'>
                <Link className='top-mover-container' href={`/${lang}/liverate/${hightlight.top_gainer.slug}/trade`}>
                ...
                <Link className='top-mover-container' href={`/${lang}/liverate/${hightlight.highest_volume.slug}/trade`}>
                    <div className='top-mover-container-left'>
                ...
                <Link className='top-mover-container truncate' href={`/${lang}/liverate/${hightlight.most_popular.slug}/trade`}>
                    <div className='top-mover-container-left'>
