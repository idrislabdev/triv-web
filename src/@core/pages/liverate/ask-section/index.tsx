...
const LiverateAskSection = (props: { lang: string; objLang: any }) => {
            ...
            <li>
              ...
              >
                <div className="content-area flex flex-col gap-[20px]">
                  <p>
                    {objLang.questions[1].description.text_1}{' '}
                    <span>
                      <Link href={`/${lang}`} className="text-primary">
                        {objLang.questions[1].description.link_1}
                      </Link>
                    </span>{' '}
                    {objLang.questions[1].description.text_2}{' '}
                  </p>
                </div>
              </div>
            </li>
