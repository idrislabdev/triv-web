      ...
      <div className="info-container">
        <div className="info-card">
          ...
          <div className="card-content">
            ...
            <a href="mailto:help@triv.co.id">
              {objLang.enquire.link} <ArrowRightIcon color={'#fff'} />
            </a>
          </div>
        </div>
        <div className="info-card">
          ...
          <div className="card-content">
            ...
            <a href="https://triv.freshdesk.com/support/home" target="_blank">
              {objLang.live_chat.link} <ArrowRightIcon color={'#fff'} />
            </a>
          </div>
        </div>
        <div className="info-card">
          ...
          <div className="card-content">
            ...
            <a href="tel:+62140200828">
              {objLang.by_post.link} <ArrowRightIcon color={'#fff'} />
            </a>
          </div>
        </div>
      </div>
