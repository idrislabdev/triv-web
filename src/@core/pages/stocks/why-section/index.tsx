    ...
    const inViewport = () => {
        ...
        if (element) {
          ...
          if(window.innerHeight > top && bottom > 0) {
            document.getElementsByClassName("stocks-why-section")[0].classList.add('animate')
          } else {
            document.getElementsByClassName("stocks-why-section")[0].classList.remove('animate')
          }
        }
      }
        ...
        <section className='stocks-why-section'>
            <div className='container'>
                <div className='title-container'>
                    <h1 className='fade-in entry-1'>{objLang.title_1} <span>{objLang.title_2}</span> {objLang.title_3}</h1>
                    <p className='fade-in entry-2'>{objLang.description}</p>
                </div>
                <div className='description-container'>
                    <Image src='/images/backgrounds/rocket-background.png' className='fade-in entry-3' alt='rocket background' width={0} height={0} sizes='100%' />
