...
const StocksFaqSection = (props: {langObj:any}) => {
    const { langObj } = props
                        ...
                        <li>
                            <button type="button" onClick={_ => setSelected(selected !== "1" ? "1" : "")}>
                                <div className="header-button"> 
                                    <label>{langObj.questions[0].title} </label> 
                            ...
                            <div className={`accordion-content ${selected === "1" ? `max-h-[400px]` : 'max-h-0'}`} ref={container1}>
                                <div className="content-area">
                                    <p>{langObj.questions[0].description}</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <button type="button" onClick={_ => setSelected(selected !== "2" ? "2" : "")}>
                                <div className="header-button"> 
                                    <label>{langObj.questions[1].title}</label> 
                            ...
                            <div className={`accordion-content ${selected === "2" ? `max-h-[400px]` : 'max-h-0'}`} ref={container2}>
                                <div className="content-area">
                                    <p>{langObj.questions[1].description}</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <button type="button" onClick={_ => setSelected(selected !== "3" ? "3" : "")}>
                                <div className="header-button"> 
                                    <label> {langObj.questions[2].title}</label> 
                            ...
                            <div className={`accordion-content ${selected === "3" ? `max-h-[400px]` : 'max-h-0'}`} ref={container2}>
                                <div className="content-area">
                                    <p>{langObj.questions[2].description}</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <button type="button" onClick={_ => setSelected(selected !== "4" ? "4" : "")}>
                                <div className="header-button"> 
                                    <label> {langObj.questions[3].title}</label> 
                                    <svg className={`w-[14px] h-[14px] text-gray-500 ${selected === "4" ? 'transform rotate-180' : ''}`} 
                                        fill="none" strokeLinecap="round" 
                                        strokeLinejoin="round" 
                                        strokeWidth="2" 
                                        viewBox="0 0 24 24" 
                            ...
                            <div className={`accordion-content ${selected === "4" ? `max-h-[400px]` : 'max-h-0'}`} ref={container2}>
                                <div className="content-area">
                                    <p>{langObj.questions[3].description}</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            <button type="button" onClick={_ => setSelected(selected !== "5" ? "5" : "")}>
                                <div className="header-button"> 
                                    <label> {langObj.questions[4].title}</label> 
                                    <svg className={`w-[14px] h-[14px] text-gray-500 ${selected === "5" ? 'transform rotate-180' : ''}`} 
                                        fill="none" strokeLinecap="round" 
                                        strokeLinejoin="round" 
                                        strokeWidth="2" 
                                        viewBox="0 0 24 24" 
                            ...
                            <div className={`accordion-content ${selected === "5" ? `max-h-[400px]` : 'max-h-0'}`} ref={container2}>
                                <div className="content-area">
                                    <p>{langObj.questions[4].description}</p>
                                </div>
                            </div>
                        </li>
                    </ul>
