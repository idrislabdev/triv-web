          ...
          <div className="terdaftar-subcontainer">
            ...
            <div className="terdaftar-diawasi">
              <div className="img-wrapper">
                <Image
                  src="/images/otoritas-keuangans/bsi-logo.png"
                  className="bsi-logo"
                  alt="bsi"
                  width={45.15}
                  height={24.69}
              ...
              <div className="img-wrapper">
                <Image
                  src="/images/otoritas-keuangans/cisa-logo.png"
                  className="cisa-logo"
                  alt="cisa"
                  width={35.98}
                  height={33.16}
              ...
              <div className="img-wrapper">
                <Image
                  src="/images/otoritas-keuangans/cism-logo.png"
                  className="cism-logo"
                  alt="cism"
                  width={79.01}
                  height={30.33}
              ...
              <div className="img-wrapper">
                <Image
                  src="/images/otoritas-keuangans/pci-logo.png"
                  className="pci-logo"
                  alt="pci"
                  width={35.98}
                  height={28.92}
              ...
              <div className="img-wrapper">
                <Image
                  src="/images/otoritas-keuangans/cissp-logo.png"
                  className="cissp-logo"
                  alt="cissp"
                  width={106.26}
                  height={31.13}
                />
