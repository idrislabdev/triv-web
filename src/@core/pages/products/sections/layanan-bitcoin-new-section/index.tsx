...
const ProductsLayananBitcoinNewSection = (props: {objLang:any}) => {
  const { objLang } = props
      ...
      <div className='layanan-container'>
        ...
        <div className='card-subcontainer hoddl sticky top-[170px] translate-y-[0px]' style={{scale:elHoddl}}>
          ...
          <div className={`box-img ${objLang.card.hoddl.image_class}`}>
            <Image src={objLang.card.hoddl.image_url} alt={objLang.card.hoddl.title} width={0} height={0} sizes='100%'/>
          </div>
        </div>
        <div className='card-subcontainer kirim sticky top-[190px] translate-y-[0px]' style={{scale:elKirim}}>
          ...
          <div className={`box-img ${objLang.card.kirim.image_class}`}>
            <Image src={objLang.card.kirim.image_url} alt={objLang.card.kirim.title} width={0} height={0} sizes='100%'/>
          </div>
        </div>
        <div className='card-subcontainer jual-beli sticky top-[210px] translate-y-[0px]' style={{scale:elJualBeli}}>
          ...
          <div className={`box-img ${objLang.card.jual_beli.image_class}`}>
            <Image src={objLang.card.jual_beli.image_url} alt={objLang.card.jual_beli.title} width={0} height={0} sizes='100%'/>
          </div>
        </div>
...
export default ProductsLayananBitcoinNewSection
