...
const ProductsServiceHeaderPaypalNewSection = (props: {asset:any, lang:any, objLang:any, objProduct:any}) => {
        ...
        <section className='products-service-hero-new-section'>
            <div className='service-hero-container'>
                ...
                <div className='right-subcontainer fade-in entry-5'>
                    <FormServicePaypal asset={asset} lang={lang} objProduct={objProduct} objLang={objLang} imgObj={objLang.image_url ? objLang.image_url : ''}/>
                </div>
            </div>
        </section>
      )
