...
const ProductsTopupPulsaSection = (props: {objLang:any}) => {
    const { objLang } = props
    const pulsas = ['indosat', 'Telkomsel', 'XL']
    return (
        <section className='products-topup-section'>
            <div className='image-container'>
                <Image src='/images/devices/iphone-topup.png' alt='iphone' width={0} height={0} sizes='100%'/>
            </div>
...
export default ProductsTopupPulsaSection
