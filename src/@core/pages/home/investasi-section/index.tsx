            ...
            <div className='investasi-section-box'>
                ...
                <div className='investasi-details'>
                    <div className='investasi-detail'>
                        ...
                        <Image src='/images/devices/iphone-15pro-a.png' alt='iphone 15 pro' width={0} height={0} sizes='100%'/>
                    </div>
                    <div className='investasi-detail'>
                        <div className='investasi-detail-description'>
                        ...
                        <Image src='/images/devices/iphone-15pro-b.png' alt='iphone 15 pro' width={0} height={0} sizes='100%' />
                    </div>
                    <div className='investasi-detail'>
                        <div className='investasi-detail-description'>
                        ...
                        <Image src='/images/devices/iphone-15pro-c.png' alt='iphone 15 pro' width={0} height={0} sizes='100%'/>
                    </div>
                </div>
            </div>
        </section>
