    ...
    return (
        <div>
            ...
            <main className='home-page sm:mobile-responsive md:mobile-responsive light-theme'>
                ...
                <HomeInvestasiSection lang={lang} objLang={objLang.easy_invest_section}/>
                <HomeTransaksiSection lang={lang} objLang={objLang.transaksi_section}/>
                <HomeDividenStakingSection lang={lang} objLang={objLang.dividen_section} />
                <HomeEwalletSection objLang={objLang.ewallet_section} />
                <BaruCryptoSection objLang={objLang.new_crypto_section} />
                <HomeBuySellAssetsSection lang={lang} objLang={objLang.invest_section}/>
